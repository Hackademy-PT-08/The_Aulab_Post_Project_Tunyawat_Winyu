...
@section('content')
    ...
    <div class="container-fluid mb-5">
        <div class="col-12">
            <div class="row">
                <h3 class="text-center py-5">Work With Us</h3>
            </div>
            <div class="row roles">
                <div class="col-4">
    ...
    <div class="container mb-4">
        <div class="col-12">
            <div class="row">
                <h3 class="text-center py-5">Application Form</h3>
            </div>
            <form action="{{ route('workWithUs.store') }}" method="post">
                @csrf
                <div class="form-group">
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="user-description">Why should we hire you?</label>
                        <textarea class="form-control" name="presentation" id="user-description" rows="3" placeholder="write a little about yourself"></textarea>
                    </div>
                    <div class="btn">
